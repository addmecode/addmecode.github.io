...
### Translation Files
- [XLIFF translation files](https://yzhums.com/2684/)

### Connecting to BC SQL Server on Docker
- [How to access SQL database inside docker container?](https://www.sauravdhyani.com/2020/11/msdyn365bc-how-to-access-sql-database.html)

### AL Guidelines
- [alguidelines.dev](https://alguidelines.dev/)
- [GH microsoft/alguidelines · Discussions · GitHub](https://github.com/microsoft/alguidelines/discussions)
- [YT Waldo - AL Development Design Patterns for the Future](https://www.youtube.com/watch?v=CWpaD9RUa6U)

### MCP
- [GH JeremyVyska/bc-code-intelligence-mcp](https://github.com/JeremyVyska/bc-code-intelligence-mcp)
- [GH StefanMaron/AL-Dependency-MCP-Server](https://github.com/StefanMaron/AL-Dependency-MCP-Server)
